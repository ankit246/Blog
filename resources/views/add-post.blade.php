  ...
  <!-- Main content -->
    <section class="content">
      <div class="tab-pane active" id="settings">
                <form class="form-horizontal" enctype="multipart/form-data" method="post" action="{{route('add.post')}}">
                  @csrf
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" value="{{old('subTitle')}}" name="subTitle" id="subTitle" placeholder="Sub Title">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" value="{{old('createdBy')}}" name="createdBy" id="subTitle" placeholder="Sub Title">
                    </div>
                  </div>
                  <div class="form-group">
