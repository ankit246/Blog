  ...
  <!-- Main content -->
    <section class="content">
      <div class="tab-pane active" id="settings">
                <form class="form-horizontal" method="post" action="{{route('about.content')}}">
                  @csrf
                  <div class="form-group">
                    <label for="inputName" class="col-sm-2 control-label">Title</label>

                    <div class="col-sm-8">
                      <input type="text" class="form-control" value="{{old('title') ?? $about->title}}" name="title" id="title" placeholder="Title">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" value="{{old('subTitle') ?? $about->sub_title}}" name="subTitle" id="subTitle" placeholder="Sub Title">
                    </div>
                  </div>
                  <div class="form-group">
